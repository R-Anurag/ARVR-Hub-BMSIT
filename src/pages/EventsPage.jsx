            ...
            <div className="flex justify-center p-8">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 w-full max-w">
                {events.map((event, index) => (
                  <div
                    key={event.id}
                    className={`group relative rounded-3xl overflow-hidden border-4 border-purple-400/60 hover:border-purple-400/60 transition-all duration-500 ${
                      isLoaded
                        ? "opacity-100 translate-y-0"
